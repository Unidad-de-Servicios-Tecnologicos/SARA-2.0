      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-1">
                {ficha ? `Ficha ${ficha.numero} - ${ficha.programa?.nombre}` : "Gestión de asistencia"}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 mb-8">
            ...
            {ficha && ` Mostrará el registro de asistencia para la ficha ${ficha.numero}.`}
          </p>
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 max-w-2xl mx-auto">
              ...
              <dl className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <dd className="font-medium text-gray-900 dark:text-white">{ficha.estado}</dd>
                </div>
                <div className="flex justify-between">
